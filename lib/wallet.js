...
var getTraceabilityUnspents = require('./network').getTraceabilityUnspents;
...
Wallet.prototype.fetchTraceabilityUnspents = function() {
  var unspentsTxIds = []
  for (var i = 0; i < this.unspents.length; i++) {
    unspentsTxIds.push(this.unspents[i].txId)
  }
  console.log(this.unspents)
  console.log(unspentsTxIds)
  getTraceabilityUnspents(this.api, this.unspents)
  .then(data => {
    this.traceabilityUnspents = data })
    .catch(console.error)
}
